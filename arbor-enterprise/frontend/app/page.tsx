...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* ─── Hero ─── */}
      <section className="relative overflow-hidden bg-background noise-texture">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-20 md:pt-32 md:pb-32">
          <AnimatedSection className="mx-auto max-w-3xl text-center">
            <div className="mb-6 inline-flex items-center gap-2 border-2 border-primary/20 bg-primary/5 px-4 py-1.5 text-sm text-primary animate-bounce-in">
          ...
          <AnimatedSection delay={0.2} className="mx-auto mt-16 max-w-5xl">
            <div className="border-2 border-border bg-card p-1 shadow-render-lg noise-texture">
              <div className="bg-muted p-8 md:p-12">
                <AnimatedSection animateChildren stagger={0.1} className="grid grid-cols-1 gap-4 md:grid-cols-3">
                  {[
                    {
                      label: "Vector Search",
                    ...
                    <AnimatedItem key={item.label}>
                      <div className="border-2 border-border bg-card p-5 transition-all hover:border-primary">
                        ...
                        <p className="mt-1 text-sm text-muted-foreground font-mono">{item.desc}</p>
                      </div>
                    </AnimatedItem>
                  ))}
                </AnimatedSection>
      ...
      {/* ─── Features Grid ─── */}
      <section id="features" className="py-24 relative bg-background noise-texture">
            ...
            {FEATURES.map((feature, idx) => (
              <AnimatedItem key={feature.title}>
                <div className="group relative border-2 border-border bg-card p-6 transition-all hover:border-primary">
                  ...
                  <div className="mb-4 inline-flex h-11 w-11 items-center justify-center bg-primary/10 text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300 relative z-10 group-hover:scale-110">
                    <feature.icon className="h-5 w-5" />
                  </div>
                  <h3 className="text-lg font-semibold text-foreground font-mono relative z-10">
                    {feature.title}
                  </h3>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground font-mono relative z-10">
                    {feature.description}
                  </p>
                </div>
              </AnimatedItem>
      ...
      {/* ─── Pricing ─── */}
      <section id="pricing" className="bg-muted py-24 noise-texture">
        <div className="mx-auto max-w-7xl px-6">
          <AnimatedSection className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-foreground md:text-4xl font-mono">
          ...
          <AnimatedSection animateChildren stagger={0.2} className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              {
                name: "Free",
                price: "$0",
                ...
                >
                  ...
                  <ul className="mt-6 space-y-3">
                    {plan.features.map((feature) => (
                      ...
                      >
                        <CheckCircle className="h-4 w-4 shrink-0 text-primary animate-bounce-in" />
                        {feature}
                      </li>
                    ))}
                  </ul>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <AnimatedSection>
            <div className="relative border-2 border-primary bg-primary px-8 py-16 text-center md:px-16">
              ...
              <p className="mx-auto mt-4 max-w-xl text-lg text-blue-100 font-mono relative z-10">
