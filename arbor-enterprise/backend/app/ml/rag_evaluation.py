...
Only respond with a number between 0 and 1.""",
    ...
    async def _evaluate_single(
        ...
        # Faithfulness
        result.faithfulness = await self._score_faithfulness(example.answer, example.contexts)

        # Answer Relevancy
        result.answer_relevancy = await self._score_relevancy(example.query, example.answer)
